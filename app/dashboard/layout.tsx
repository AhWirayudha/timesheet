    ...
    <header className="border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <nav className="flex items-center space-x-6">
          ...
          <Link href="/timesheet" className="text-sm font-medium text-gray-700 hover:text-gray-900">
            Timesheet
          </Link>
          <Link href="/timesheet/dashboard" className="text-sm font-medium text-gray-700 hover:text-gray-900">
            Analytics
          </Link>
        </nav>
